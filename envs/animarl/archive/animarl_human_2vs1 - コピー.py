...
class Animarl_Human_2vs1(MultiAgentEnv):
    ...
    def __init__(
        ...
        space_dim=2,
        reward_dim=12,
        speed_pursuer=2.7, speed_evader=3.3, mass_pursuer1=1, mass_pursuer2=1,  mass_evader=1, 
        damping=0.25, dt=0.1, reward_share=True # (default) speed_pursuer=2.4/2.0, speed_evader=3.0/2.5
    ):
        self.dense_reward = dense_reward
        self.write_full_episode_dumps = write_full_episode_dumps
        self.write_touch_dumps = write_touch_dumps
        ...
        self.n_mate = n_agents-number_of_preys
    ...
    def check_if_done(self):
        ...
        if ball_loc[0] < 0 or any(ours_loc[:, 0] < -0.1):
            if self.time_step < 4:
